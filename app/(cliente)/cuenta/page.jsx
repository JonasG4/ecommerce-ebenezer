...
export default function AccountPage() {
  ...
  return (
    <div className="flex justify-center w-full my-6 ">
      <div className="w-[90%] monitor:w-[1350px] flex flex-col items-center">
        <div
          id="alert"
          ref={alertRef}
          className={`w-[80%] h-[0px] bg-green-600 shadow-md px-4 flex gap-2 items-center rounded-t-sm overflow-hidden duration-150 ease-in-out`}>
          <CheckBadgeIcon className="w-5 h-5 text-white" />
          <p className="text-white font-semibold">Guardado con éxito</p>
          <XMarkIcon className="w-5 h-5 text-white cursor-pointer ml-auto" />
        </div>
        <main className="flex w-[80%] h-[400px] bg-white rounded-sm shadow-md ring-1 ring-gray-300">
          <aside className="w-[200px] h-full  bg-gray-50">
            <ul className="grid auto-rows-[50px] bg-gray-50 h-full">
              <li
                id="perfil"
                className={`w-full flex gap-2 items-center pl-4 border-r hover:border-r-2 hover:border-red-800/60 font-bold border-gray-700/10 hover:bg-gray-100 cursor-pointer text-gray-600 duration-150 ease-in-out ${optSelected === "perfil" ? "bg-gray-100 border-r-2 border-red-800/60" : ""
                  }`}
                onClick={(e) => setOptSelected("perfil")}
              >
                <span>Mi perfil</span>
              </li>
              <li
                id="pedidos"
                className={`w-full flex gap-2 items-center pl-4 border-r hover:border-r-2 hover:border-red-800/60 border-gray-700/10 hover:bg-red-100 cursor-pointer text-gray-600 duration-150 ease-in-out ${optSelected === "pedidos" ? "bg-red-100 border-r-2 border-red-800/60" : ""
                  }`}
                onClick={(e) => setOptSelected("pedidos")}
              >
                <span>
                  Mis pedidos
                </span>
              ...
              <li
                id="favoritos"
                className={`w-full flex gap-2 items-center pl-4 border-r hover:border-r-2 hover:border-red-800/60 border-gray-700/10 hover:bg-red-100 cursor-pointer text-gray-600 duration-150 ease-in-out ${optSelected === "favoritos" ? "bg-red-100 border-r-2 border-red-800/60" : ""
                  }`}
                onClick={(e) => setOptSelected("favoritos")}
              >
                <span>
                  Mis favoritos
                </span>
              ...
              <li
                id="cerrar-sesion"
                role="button"
                className={`w-full flex gap-2 items-center pl-4  hover:bg-gray-100 cursor-pointer text-red-600 duration-150 ease-in-out}`}
                onClick={(e) => signOut()}
              >
